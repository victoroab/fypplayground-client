    ...
    try {
      const request = await Axios.post(
        '/student/register',
        {
          ...
          areasOfInterest: formData.aoi.split(','),
                      ...
                      <div className="w-full rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                          ...
                          <div className="space-y-4 mb-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. To what extent do you try to see situations
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How effectively do you convey your thoughts
                                and ideas to others?
                              </label>
                              <input
                                type="number"
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. How often do you seek clarification and
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. To what extent are you able to maintain a
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How receptive are you to different opinions
                                and ideas?
                              </label>
                              <input
                                type="number"
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. To what extent do you actively seek out
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. How easily do you embrace and navigate
                                through transitions?
                              </label>
                              <input
                                type="number"
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How often do you take initiative and guide
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                2. How well do you inspire and motivate others
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How consistently do you fulfill your
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How effectively do you analyze complex
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                2. How optimistic and positive are you in the
                                face of challenges?
                              </label>
                              <input
                                type="number"
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. How readily do you adapt and learn from
                          ...
                          <div className="space-y-4 flex flex-col items-start justify-center md:space-y-6">
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                1. How reliable and consistent are you in
                            ...
                            <div className="flex flex-col items-start gap-1 justify-center">
                              <label className="block text-sm font-medium text-white">
                                3. To what extent do others feel comfortable
